...
const HamburgerMenu = ({ widgetId, settings }) => {
  ...
  const showIconValue = showIcon !== undefined ? showIcon : true;
  ...
  return (
    <>
      ...
      >
        {iconPosition === 'left' && showIconValue && <HamburgerIcon />}
        <span className="ph-hamburger-text">{menuText}</span>
        {iconPosition === 'right' && showIconValue && <HamburgerIcon />}
      </button>
